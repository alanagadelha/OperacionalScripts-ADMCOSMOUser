...
dflag=${WORKDIR}/data.data33/ready${HH}
dtrab=${WORKDIR}/data.data33/backup${HH}
...
if [ -s ${dtrab}/${DADOSORIPREF}_${datamaq}000 ];then
	...
	if [ ${datamaq} -eq ${datarq} ];then
		...
		scp ${dtrab}/cosmomet_07km_${HH}_${datamaq}${SUFIX} admbackup@10.13.100.33:/data1/backup/backup_cosmo/dados${HH}
