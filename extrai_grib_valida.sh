...
DIRDADOSORI=/home/admcosmo/cosmo/metarea5/data/prevdata$HH
DIRDADOSEXT=/home/admcosmo/cosmo/metarea5/data/valida_${HH}/cosmo_grib_$data
DADOSORIPREF="cosmo_met5_${HH}_$curr_date"
DADOSDESPREF="cosmo_met5_${HH}_$curr_date"
